...
import pl.app.user.mapper.ProductMapper;
import pl.app.user.service.impl.ProductServiceImpl;
...
//    @PreAuthorize("hasAnyRole('ADMIN', 'USER')")
    @GetMapping("/current")//dla wszystkich
    public void getCurrentProduct() {
//        Page<Product> page1 = productServiceImpl.getPage(PageRequest.of(page, size));
        productServiceImpl.getCurentProduct();
    }
